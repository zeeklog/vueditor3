/* WebUploader 0.1.2 */ !(function (a, b) {
  ...
  return (
          ...
          ;(this.uid = a.guid('client_')),
            ...
            (this.disconnectRuntime = function () {
              f &&
                (f.__client--,
                f.__client <= 0 &&
                  (e.remove(f), delete f.__promise, f.destroy()),
                (f = null))
            }),
            (this.exec = function () {
              if (f) {
    ...
    b(
      'runtime/html5/blob',
      ['runtime/html5/runtime', 'lib/blob'],
      function (a, b) {
