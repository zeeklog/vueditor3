          ...
          function ($0, $1, $2) {
            ...
            if ($1) {
              switch ($1) {
                ...
                default: // Type conversion; drop leading zero
                  // What does "$10" mean?
...
;(function () {
  ...
  function Brush() {
    ...
    this.regexList = [
      ...
      {
        regex:
          /\b(?:about|above|against|around|at|below|beneath|beside|between|by|(apart|aside) from|(instead|out) of|into|on(to)?|over|since|thr(ough|u)|under)\b/g,
        css: 'color3'
      },
