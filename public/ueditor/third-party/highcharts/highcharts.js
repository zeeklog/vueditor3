...
;(function () {
    ...
    O.HighchartsAdapter =
      ...
      (a && {
        init: function (b) {
          ...
          a.each(
            ['cur', '_default', 'width', 'height', 'opacity'],
            function (a, b) {
              var e = d,
                k,
                l
  ...
  M = {
    colors:
      '#2f7ed8,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a'.split(
        ','
      ),
  ...
  Pa.prototype = {
    ...
    destroyElements: function () {
      for (
        var a =
            'graphic,dataLabel,dataLabelUpper,group,connector,shadowGroup'.split(
              ','
            ),
          b,
          c = 6;
  ...
  Q.prototype = {
    ...
    drawLegendSymbol: function (a) {
      ...
      if (c && c.enabled)
        (b = c.radius),
          (this.legendSymbol = e =
            f.symbol(this.symbol, e / 2 - b, a - b, 2 * b, 2 * b).add(g)),
          (e.isMarker = !0)
    },
